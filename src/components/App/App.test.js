...
describe('App Tests', () => {
  ...
  it('should display error if login credentials are invalid', async () => {
    // apiFetchMovies.mockResolvedValue(fetchedMovies);
    // apiFetchUserData.mockResolvedValue({
    ...
    const { getByText, getByPlaceholderText, getByTestId, getAllByText, debug } = utils

    fireEvent.click(getByTestId('login-page-btn'));
  ...
  it('should be able to login successfully', async () => {
    ...
    // }
    // apiFetchMovies.mockResolvedValue(fetchedMovies);
    // apiFetchUserData.mockResolvedValue(fetchedUserData);
